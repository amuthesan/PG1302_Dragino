...
def configure():
    ...
    if not all([lns_uri, cups_uri, api_key]):
    ...
    commands = [
        ...
        "wget -nc -O /tmp/draginofwd.deb https://www.dragino.com/downloads/downloads/LoRa_Gateway/PG1302/software/draginofwd-32bit.deb && dpkg -i /tmp/draginofwd.deb",
        # Fix SPI
        ...
        f"echo 'Authorization: Bearer {api_key}' > /etc/station/tc.key",
        f"echo 'Authorization: Bearer {api_key}' > /etc/station/cups.key",
        # Certs
